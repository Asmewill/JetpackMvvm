                    ...
                    R.id.item_home_author, R.id.item_project_author -> {
                        nav().navigateAction(
                            ...
                            Bundle().apply {
                                putInt(
                                    "id",
                                    articleAdapter.data[position - this@PlazaFragment.mDatabind.recyclerView.headerCount].userId
                                )
                            })
                    }
                }
    ...
    override fun createObserver() {
        ...
        appViewModel.run {
            ...
            appColor.observeInFragment(this@PlazaFragment, Observer {
                setUiTheme(it, mDatabind.floatbtn, mDatabind.swipeRefresh, loadsir)
            })
            //监听全局的列表动画改编
